...
public class Board {
	...
	public Board() {
	 ...
	 //SASHA Done? Thanks to Aaron TODO: initialise the cells array using ROWS and COLS constants
	...
	public boolean isDraw() {
		...
		// SASHA done? TODO: Check whether the game has ended in a draw. 
	...
	public boolean hasWon(Player thePlayer, int playerRow, int playerCol) {
		...
		if(cells[playerCol][0].content == thePlayer && cells[playerCol][1].content == thePlayer && cells[playerCol][2].content == thePlayer )
		 ...
		 // SASHA Done TODO: Check if the player has 3 in the playerCol.
		...
		if( cells[0][2].content == thePlayer && cells[1][1].content == thePlayer && cells[2][0].content == thePlayer)
			return true;
		// SASHA done   TODO: Check the diagonal in the other direction
