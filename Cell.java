...
public class Cell {
	...
	public Cell(int row, int col) {
		...
		// SASHA done??? TODO: Initialise the variables row, col 
		this.row = row;
		this.col = col;

		
		
		//SASHA done?? TODO: call the method that sets the cell content to EMPTY
		  clear(); 
	}
	...
	public void clear() {
		...
		if(content == Player.Nought  || content == Player.Cross) {
            content = Player.Empty;
        }
		// SASHA: done??? TODO: Set the value of content to Empty (Remember this is an enum)
